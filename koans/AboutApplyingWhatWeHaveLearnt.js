...
describe("About Applying What We Have Learnt", function() {
  ...
  it("given I'm allergic to nuts and hate mushrooms, it should find a pizza I can eat (functional)", function () {
      ...
      var noNuts = function(prod) { return prod.containsNuts == false };

      var isMushrooms = function(ing) { return ing == 'mushrooms' };
      ...
      productsICanEat = productsWithNoMushrooms.filter(noNuts);
